...
class App extends React.Component {
  state = {
    contacts: [
      { id: 'id-1', name: 'Rosie Simpson', number: '222-44-66' },
      { id: 'id-2', name: 'Hermione Kline', number: '444-88-22' },
      { id: 'id-3', name: 'Eden Clements', number: '333-00-77' },
      { id: 'id-4', name: 'Ann Simp', number: '555-91-11' },
      { id: 'id-4', name: 'Rosa Golovko', number: '123-45-67' },
    ],
    filter: '',
  };
